...
const App = () => {
	...
	const editionDropAddress = "0x4998B6d614B3e6B9595E0362B5800B27b346035F";
	...
	if (!address) {
		return (
			<div className="landing">
				<h1>Bem-vind@s à ClimbDAO - a DAO dos escaladores</h1>
	...
	if (hasClaimedNFT) {
		return (
			<div className="member-page">
				...
				<p>Parabéns por fazer parte desse clube de climbers!</p>
				<div>
					<div>
						...
						>
							{proposals.map((proposal) => (
								<div
									...
									className={`card ${hasVoted ? "cardVoted" : ''}`}
								>
